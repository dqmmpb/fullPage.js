/**
 * ie8-shim, dependencies `es5-shim`
 */
(function () {
  "use strict;"
  ...
  if (!Element.prototype.addEventListener) {
    ...
    Element.prototype.createEvent = HTMLDocument.prototype.createEvent = Window.prototype.createEvent = createEvent;
    ...
    var dispatchEvent = function dispatchEvent(event) {
      var self = this, eventName = event.type;
  ...
  if (!Event.prototype.initCustomEvent) {
    Event.prototype.initCustomEvent = function (typeArg, canBubbleArg, cancelableArg, detailArg) {
      this.type = typeArg;
